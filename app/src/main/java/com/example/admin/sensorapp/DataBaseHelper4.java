...
public class DataBaseHelper4 extends SQLiteOpenHelper
{
    ...
    private static final String TAG = "DatabaseHelper4";
    private static final String TABLE_NAME = "Magnetometer_New";
    ...
    private static final String T1_COL5 = "Degrees";
    private static final String T1_COL6 = "Radian";
...
//        SQLiteDatabase temp = this.getReadableDatabase();
    ...
    {
        String createTable = "CREATE TABLE " + TABLE_NAME + "( created_at DATETIME DEFAULT CURRENT_TIMESTAMP," + T1_COL2 + " REAL," + T1_COL3 + " REAL," + T1_COL4 + " REAL,"+ T1_COL5 + " REAL,"+ T1_COL6 + " REAL)";
    ...
    public boolean addDataMagnet(float x, float y, float z, double deg, double rad)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        contentValues.put(T1_COL5, deg);
        Log.d(TAG, "addData: Adding " + deg + " to " + TABLE_NAME);
        contentValues.put(T1_COL6, rad);
        Log.d(TAG, "addData: Adding " + rad + " to " + TABLE_NAME);
