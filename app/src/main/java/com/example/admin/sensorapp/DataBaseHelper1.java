...
public class DataBaseHelper1 extends SQLiteOpenHelper
{
    ...
    private static final String TABLE_NAME = "Accelerometer_New";
    ...
    private static final String T1_COL5 = "NEW_X";
    private static final String T1_COL6 = "NEW_Y";
    private static final String T1_COL7 = "NEW_Z";
...
//        SQLiteDatabase temp = this.getReadableDatabase();
    ...
    {
        String createTable = "CREATE TABLE " + TABLE_NAME + "( created_at DATETIME DEFAULT CURRENT_TIMESTAMP," + T1_COL2 + " REAL," + T1_COL3 + " REAL," + T1_COL4 + " REAL," + T1_COL5 + " REAL," + T1_COL6 + " REAL," + T1_COL7 + " REAL)";
    ...
    public boolean addDataAcc(float x, float y, float z, float X, float Y, float Z)
//    public boolean addDataAcc(float x, float y, float z)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        contentValues.put(T1_COL5, X);
        Log.d(TAG, "addData: Adding " + X + " to " + TABLE_NAME);
        contentValues.put(T1_COL6, Y);
        Log.d(TAG, "addData: Adding " + Y + " to " + TABLE_NAME);
        contentValues.put(T1_COL7, Z);
        Log.d(TAG, "addData: Adding " + Z + " to " + TABLE_NAME);
