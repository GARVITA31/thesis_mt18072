...
public class CustomAdapter2 extends BaseAdapter
{
    ...
    public CustomAdapter2(Context  context, ArrayList<String> Timestamp, ArrayList<Float> X, ArrayList<Float> Y, ArrayList<Float> Z)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mydb = new DataBaseHelper2(mContext);
        LayoutInflater layoutInflater;
        if (convertView == null)
        {
            layoutInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.list_item_layout_gyroscope, null);
