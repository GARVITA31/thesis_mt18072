...
public class ShowDataListView2 extends AppCompatActivity
{
    ...
    private void displayData()
    {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM  Gyroscope",null);
        Timestamp.clear();
        X.clear();
        Y.clear();
        Z.clear();
...
//        }
        ...
        CustomAdapter2 ca = new CustomAdapter2(ShowDataListView2.this, Timestamp, X, Y, Z);
        lv.setAdapter(ca);
